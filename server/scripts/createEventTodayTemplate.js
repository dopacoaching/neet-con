/**
 * One-off: submit today's (2026-08-15) event-reminder template to Meta
 * WhatsApp Manager for approval. Has an IMAGE header (the poster provided),
 * plus body text with the 7:30 PM IST start time, tonight's Zoom link/ID/
 * passcode, and the WhatsApp group link.
 *
 * Usage: node scripts/createEventTodayTemplate.js
 *
...
const BODY_TEXT = [
  'Hi *{{full_name}}*, quick reminder — today\'s CareeRx session starts at *7:30 PM IST* (Ticket ID: {{ticket_id}}).',
  'Join tonight\'s session via Zoom:\n{{zoom_link}}\nMeeting ID: 822 0485 3317\nPasscode: 823792',
  `Also stay connected via our official WhatsApp group for live updates and upcoming session details:\n${GROUP_LINK}`,
  'See you tonight!',
].join('\n\n');
